...
18. Супер, последний шаг! Наберите в `git bash` `winpty python hello.py` и нажмите `Enter`. После этого у вас должен сработать скрипт hello, и вывести вам сообщение на экран.
